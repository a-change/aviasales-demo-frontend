  ...
  return (
    <Help>
      <div className="container">
        <div className="row">
          <div className="col-xs-12 col-xs-offset-0 col-xl-10 col-xl-offset-1">
            <Title>
              <Logo src={plane} alt="" />
              <Text>КАК КУПИТЬ ДЕШЕВЫЕ АВИАБИЛЕТЫ?</Text>
            </Title>
            <Body>
            ...
            <Title>
              <Logo src={email} alt="" />
              <Text>ЭЛЕКТРОННЫЙ АВИАБИЛЕТ</Text>
            </Title>
            <Body>
            ...
            <Title>
              <Logo src={list} alt="" />
              <Text>20 СОВЕТОВ АВИАПУТЕШЕСТВЕННИКАМ</Text>
            </Title>
            <Body>
